            ...
            <li class="my-account">
              ...
              <div class="my-account-dropdown">
                @auth
                  ...
                  <div class="login-btn" style="margin-bottom: 0">
                    <form action="/logout" method="post">
                      @csrf
                      <a href="javascript:void(0)" onclick="this.closest('form').submit();return false;" class="axil-btn btn-bg-secondary">Logout</a>
                    </form>
                  </div>
                @endauth

                @guest
                  <div class="login-btn" style="margin-top: 0">
