...
@section('content')
  <div class="page-content edit-add container-fluid" x-data="product">
    <div class="row">
      <div class="col-md-12">
            ...
            <div class="panel-body">
              ...
              @foreach ($dataTypeRows as $row)
                ...
                <div
                  ...
                  @elseif ($row->field == "product_belongstomany_option_relationship")
                    <div class="flex"></div>
                  @elseif ($row->field == "product_hasmany_variant_relationship")
